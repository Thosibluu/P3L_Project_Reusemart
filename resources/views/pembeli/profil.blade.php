...
<body>
    ...
    <script>
        ...
        $(document).ready(function () {
            let isRealTimeSearch = true; // Toggle for real-time search
            ...
            $('#realTimeSearchToggle').on('change', function() {
                isRealTimeSearch = $(this).is(':checked');
                if (!isRealTimeSearch) {
                    $('#searchAddress').off('input'); // Disable real-time search
                } else {
